...
using UnityEngine;
    ...
    public class Logger : MonoBehaviour // By Alex van den Berg - https://github.com/Avdbergnmf/UnityDataLogging
    {
        ...
        [Tooltip("Set a custom filename forCreateFileWithHeaders this logger (ignoring any of the above options).")] 
        [SerializeField]
        ...
        protected void Initialize()
        {
            ...
            _logToCsv = new LogToCSV(writeEveryNLogs);
        ...
        private void CreateFiles()
        {
            if (VerifyDirectory())
            {
                ...
                {
                    string[] localReportHeaders = this.reportHeaders;
